  ...
  for (var i = 0; i < cards.length; i++) {
    ...
    let orangeSelect = "butterfly-orange";
      if(cardDetails.classList[2] === redSelect){
        cardDetails.src = 'https://github.com/rhovell/memory-game/tree/master/img/game-sets/easy/butterflies/red.png';
      }
      if(cardDetails.classList[2] === blueSelect){
        cardDetails.src = 'https://github.com/rhovell/memory-game/tree/master/img/game-sets/easy/butterflies/blue.png';
      }
      if(cardDetails.classList[2] === yellowSelect){
        cardDetails.src = 'https://github.com/rhovell/memory-game/tree/master/img/game-sets/easy/butterflies/yellow.png';
      }
      if(cardDetails.classList[2] === orangeSelect){
        cardDetails.src = 'https://github.com/rhovell/memory-game/tree/master/img/game-sets/easy/butterflies/orange.png';
      }
