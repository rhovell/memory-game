  ...
  for (var i = 0; i < cards.length; i++) {
    ...
    let sheepSelect = "farmyard-sheep";
      if(cardDetails.classList[2] === chickenSelect){
        ...
        cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/easy/farmyard/chicken.png';
      }
      if(cardDetails.classList[2] === cowSelect){
        cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/easy/farmyard/cow.png';
      }
      if(cardDetails.classList[2] === pigSelect){
        cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/easy/farmyard/pig.png';
      }
      if(cardDetails.classList[2] === sheepSelect){
        cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/easy/farmyard/sheep.png';
      }
      placedCard.appendChild(cardDetails);
    }
    // add level details to deck and body
  ...
  for (var i = 0; i < cards.length; i++) {
    ...
    let tucanSelect = "birds-tucan";
      if(cardDetails.classList[2] === hummSelect){
        cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/medium/birds/humming-bird.png';
      }
      if(cardDetails.classList[2] === kiwiSelect){
        cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/medium/birds/kiwi.png';
      }
      if(cardDetails.classList[2] === ostrichSelect){
        cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/medium/birds/ostrich.png';
      }
      if(cardDetails.classList[2] === parrotSelect){
        cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/medium/birds/parrot.png';
      }
      if(cardDetails.classList[2] === penguinSelect){
        cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/medium/birds/penguin.png';
      }
      if(cardDetails.classList[2] === tucanSelect){
        cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/medium/birds/tucan.png';
      }
      placedCard.appendChild(cardDetails);
    }
    // add level details to deck and body
  ...
  for (var i = 0; i < cards.length; i++) {
    ...
    let snailSelect = "bugs-snail";
      if(cardDetails.classList[2] === beeSelect){
        cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/medium/bugs/bee.png';
      }
      if(cardDetails.classList[2] === beetleSelect){
        cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/medium/bugs/beetle.png';
      }
      if(cardDetails.classList[2] === cricketSelect){
        cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/medium/bugs/cricket.png';
      }
      if(cardDetails.classList[2] === dragonflySelect){
        cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/medium/bugs/dragonfly.png';
      }
      if(cardDetails.classList[2] === ladybirdSelect){
        cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/medium/bugs/ladybird.png';
      }
      if(cardDetails.classList[2] === snailSelect){
        cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/medium/bugs/snail.png';
      }
      placedCard.appendChild(cardDetails);
    }
    // add level details to deck and body
  ...
  for (var i = 0; i < cards.length; i++) {
    ...
    let turtleSelect = "reptile-turtle";
      if(cardDetails.classList[2] === chamSelect){
        cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/medium/reptiles/chameleon.png';
      }
      if(cardDetails.classList[2] === cobraSelect){
        cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/medium/reptiles/cobra.png';
      }
      if(cardDetails.classList[2] === frogSelect){
        cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/medium/reptiles/frog.png';
      }
      if(cardDetails.classList[2] === lizardSelect){
        cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/medium/reptiles/lizard.png';
      }
      if(cardDetails.classList[2] === newtSelect){
        cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/medium/reptiles/newt.png';
      }
      if(cardDetails.classList[2] === turtleSelect){
        cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/medium/reptiles/turtle.png';
      }
      placedCard.appendChild(cardDetails);
    }
    // add level details to deck and body
    ...
    for (var i = 0; i < cards.length; i++) {
      ...
      let veloSelect = "dinosaur-velociraptor";
        if(cardDetails.classList[2] === ankSelect){
          cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/hard/dinosaurs/ankylosaurus.png';
        }
        if(cardDetails.classList[2] === corySelect){
          cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/hard/dinosaurs/corythosaurus.png';
        }
        if(cardDetails.classList[2] === diplSelect){
          cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/hard/dinosaurs/diplodocos.png';
        }
        if(cardDetails.classList[2] === paraSelect){
          cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/hard/dinosaurs/parasaurolophus.png';
        }
        if(cardDetails.classList[2] === pteSelect){
          cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/hard/dinosaurs/pterodactyl.png';
        }
        if(cardDetails.classList[2] === stegSelect){
          cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/hard/dinosaurs/stegosaurus.png';
        }
        if(cardDetails.classList[2] === triSelect){
          cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/hard/dinosaurs/triceratops.png';
        }
        if(cardDetails.classList[2] === veloSelect){
          cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/hard/dinosaurs/velociraptor.png';
        }
        placedCard.appendChild(cardDetails);
      }
      // add level details to deck and body
      ...
      for (var i = 0; i < cards.length; i++) {
        ...
        let polaSelect = "endangered-polar-bear";
          if(cardDetails.classList[2] === babSelect){
            cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/hard/endangered/baboon.png';
          }
          if(cardDetails.classList[2] === bearSelect){
            cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/hard/endangered/bear.png';
          }
          if(cardDetails.classList[2] === eleSelect){
            cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/hard/endangered/elephant.png';
          }
          if(cardDetails.classList[2] === hyenaSelect){
            cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/hard/endangered/hyena.png';
          }
          if(cardDetails.classList[2] === lionSelect){
            cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/hard/endangered/lion.png';
          }
          if(cardDetails.classList[2] === pandaSelect){
            cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/hard/endangered/panda.png';
          }
          if(cardDetails.classList[2] === platSelect){
            cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/hard/endangered/platypus.png';
          }
          if(cardDetails.classList[2] === polaSelect){
            cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/hard/endangered/polar-bear.png';
          }
          placedCard.appendChild(cardDetails);
        }
        // add level details to deck and body
        ...
        for (var i = 0; i < cards.length; i++) {
          ...
          let squirrelSelect = "woodland-squirrel";
            if(cardDetails.classList[2] === badgerSelect){
              cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/hard/woodland/badger.png';
            }
            if(cardDetails.classList[2] === deerSelect){
              cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/hard/woodland/deer.png';
            }
            if(cardDetails.classList[2] === foxSelect){
              cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/hard/woodland/fox.png';
            }
            if(cardDetails.classList[2] === hedgehogSelect){
              cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/hard/woodland/hedgehog.png';
            }
            if(cardDetails.classList[2] === mouseSelect){
              cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/hard/woodland/mouse.png';
            }
            if(cardDetails.classList[2] === owlSelect){
              cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/hard/woodland/owl.png';
            }
            if(cardDetails.classList[2] === rabbitSelect){
              cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/hard/woodland/rabbit.png';
            }
            if(cardDetails.classList[2] === squirrelSelect){
              cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/hard/woodland/squirrel.png';
            }
            placedCard.appendChild(cardDetails);
          }
          // add level details to deck and body
          ...
          for (var i = 0; i < cards.length; i++) {
            ...
            let whaleSelect = "sealife-whale";
              if(cardDetails.classList[2] === clownSelect){
                cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/expert/sealife/clownfish.png';
              }
              if(cardDetails.classList[2] === dolphinSelect){
                cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/expert/sealife/dolphin.png';
              }
              if(cardDetails.classList[2] === hermitSelect){
                cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/expert/sealife/hermit-crab.png';
              }
              if(cardDetails.classList[2] === kwhaleSelect){
                cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/expert/sealife/killer-whale.png';
              }
              if(cardDetails.classList[2] === octopusSelect){
                cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/expert/sealife/octopus.png';
              }
              if(cardDetails.classList[2] === puffaSelect){
                cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/expert/sealife/puffafish.png';
              }
              if(cardDetails.classList[2] === sharkSelect){
                cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/expert/sealife/shark.png';
              }
              if(cardDetails.classList[2] === squidSelect){
                cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/expert/sealife/squid.png';
              }
              if(cardDetails.classList[2] === stfishSelect){
                cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/expert/sealife/starfish.png';
              }
              if(cardDetails.classList[2] === whaleSelect){
                cardDetails.src = 'https://raw.githubusercontent.com/rhovell/memory-game/master/img/game-sets/expert/sealife/whale.png';
              }
              placedCard.appendChild(cardDetails);
            }
            // add level details to deck and body
